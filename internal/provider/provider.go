...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-timing/internal/eda/utils"
...
var _ provider.Provider = (*timingProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &timingProvider{version: ver}
	}
}
...
func (p *timingProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *timingProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *timingProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "timing-v1alpha1"
	resp.Version = p.version
}

func (p *timingProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewNtpClientDataSource,
		NewNtpClientListDataSource,
		NewResourceListDataSource,
	}
}

func (p *timingProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewNtpClientResource,
	}
}
